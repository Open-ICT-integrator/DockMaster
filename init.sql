...
(
    ...
    CONSTRAINT container_config_pkey PRIMARY KEY (id)
);
...
(
    id uuid NOT NULL,
    user_id uuid NOT NULL,
    CONSTRAINT container_stack_pkey PRIMARY KEY (id)
);
...
(
    ...
    label_id uuid NOT NULL,
    CONSTRAINT network_label_pkey PRIMARY KEY (network_id, label_id)
);
...
(
    ...
    CONSTRAINT ssh_connection_pkey PRIMARY KEY (id),
    CONSTRAINT ssh_connection_container_id_unique UNIQUE (container_id)
);
...
ALTER TABLE IF EXISTS public.container
    ADD CONSTRAINT container_dependency_id_foreign FOREIGN KEY (dependency_id)
    REFERENCES public.dependency (id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
CREATE INDEX IF NOT EXISTS container_dependency_id_index
    ON public.container(dependency_id);


ALTER TABLE IF EXISTS public.container
    ADD CONSTRAINT container_environment_id_foreign FOREIGN KEY (environment_id)
    REFERENCES public.environment (id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
CREATE INDEX IF NOT EXISTS container_environment_id_index
    ON public.container(environment_id);
...
ALTER TABLE IF EXISTS public.container
    ADD FOREIGN KEY (id)
    REFERENCES public.volume (container_stack_id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    NOT VALID;
